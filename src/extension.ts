...
export function activate(context: vscode.ExtensionContext): void {
	...
	context.subscriptions.push(
		...
		registerCommand('copyReference.claudeStyle', (resource?: CommandResource, selectedResources?: CommandResourceList) => copyReference(resource, selectedResources, 'claudeStyle')),
		registerCommand('copyReference.codexStyle', (resource?: CommandResource, selectedResources?: CommandResourceList) => copyReference(resource, selectedResources, 'codexStyle')),
		...
		registerCommand('linkActiveTerminal', () => targetManager?.linkActiveTerminal()),
